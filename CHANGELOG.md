...
- **System tray application** (`PerplexityXPC.Tray`) with `Ctrl+Shift+P` global hotkey, floating query popup, dark/light theme support, and per-MCP-server status indicators
