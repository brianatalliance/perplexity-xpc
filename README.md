...
- **System tray application** - `Ctrl+Shift+A` global hotkey for a floating query popup
...
Press `Ctrl+Shift+A` from anywhere in Windows to open the floating query popup.
